...
export default function Privacidade() {
    return (
        <div className="container-privacidade">
            ...
            <p>A sua privacidade é importante para nós. É política do  React Pet respeitar a sua privacidade em
                relação a qualquer informação sua que possamos coletar no site <a href="http://www.domínio.com">React Pet</a>, e outros sites que possuímos e operamos.</p>
            ...
            <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não
                ...
                respectivas <a href='https://politicaprivacidade.com' target='_blanck'>políticas de privacidade</a>. </p>
            ...
            <h2>Política de Cookies React Pet</h2>
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o React Pet oferece no
            ...
            <ul>
                ...
                <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou <a
                        href='https://salmao.pt/'>salmao</a>, casas de apostas online (ex.: Bet.pt), jogos de sorte e
                    azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                </li>
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do  React Pet, de seus
